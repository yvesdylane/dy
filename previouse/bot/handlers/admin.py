...
from previouse.bot.handlers.common import get_user, logger
...
async def sync_receive(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        from previouse.db.sync import sync_database
...
async def handle_attendance_code(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from previouse.models.models import Attendance, AttendanceCode, Group, InternAttendance, User
...
async def qr_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from previouse.web.security import create_qr_payload
...
async def _generate_pics(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from previouse.db.database import async_session
    from previouse.models.models import Group as GroupEnum, Role, User
