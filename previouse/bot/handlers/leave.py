...
async def _leave_show_list(update: Update, context):
    from previouse.models.models import LeaveRequest, LeaveStatus
...
async def leave_review(update: Update, context):
    ...
    from sqlalchemy.orm import selectinload
    from previouse.db.database import async_session
    from previouse.models.models import Attendance, InternAttendance, LeaveRequest, LeaveStatus, User, Role
