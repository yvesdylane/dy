...
from previouse.bot.handlers.common import get_user, reply_fn
...
async def complain_content(update: Update, context):
    ...
    from previouse.db.database import async_session
    from previouse.models.models import ComplainType, UserComplain
...
async def update_value(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from previouse.db.database import async_session
    from previouse.models.models import Gender, User
