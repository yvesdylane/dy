...
from previouse.bot.handlers import handlers as other_handlers
...
async def process_update(data: dict):
    ...
    logger.debug("Processing Telegram update from user_id=%s", data.get("message", {}).get("from", {}).get("id", "unknown"))
